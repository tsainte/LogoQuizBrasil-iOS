...
- (void)makeToast:(NSString *)message position:(id)position color:(UIColor*)color {
  
  [self makeToast:message duration:CSToastDefaultDuration position:position color:color];
}

- (void)makeToast:(NSString *)message {
  
  [self makeToast:message duration:CSToastDefaultDuration position:CSToastDefaultPosition color:[UIColor blackColor]];
}

- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration position:(id)position color:(UIColor*)color {
  
    UIView *toast = [self viewForMessage:message title:nil image:nil color:color];
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
  ...
  return [self viewForMessage:message title:title image:image color:[UIColor blackColor]];
}
